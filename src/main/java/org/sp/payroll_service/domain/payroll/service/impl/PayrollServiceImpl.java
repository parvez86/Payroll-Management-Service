...
public class PayrollServiceImpl implements PayrollService {
    ...
    @Transactional
    public CompletableFuture<PayrollBatchResponse> createPayrollBatch(CreatePayrollBatchRequest request) {
    ...
    public CompletableFuture<List<SalaryCalculation>> calculateSalaries(UUID batchId) {
    ...
    @Async("virtualThreadExecutor")
    @Transactional(readOnly = true)
    public CompletableFuture<List<SalaryCalculation>> calculateSalariesForCompany(UUID companyId) {
    ...
    public CompletableFuture<PayrollResult> processPayroll(UUID batchId) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            try {
                ...
                if (batch.getPayrollStatus() != PayrollStatus.PENDING) {
                    throw new PayrollProcessingException("Batch is not in PENDING transactionStatus: " + batch.getPayrollStatus());
                }
                ...
                for (PayrollItem item : payrollItems) {
                    try {
                        ...
                        transactionService.executeTransfer(transferRequest).join();
                ...
                // Update batch transactionStatus
                if (failedPayments == 0) {
    ...
    @Async("virtualThreadExecutor")
    @Transactional(readOnly = true)
    public CompletableFuture<Page<PayrollBatchSummary>> getAllBatches(PayrollBatchFilter filter, Pageable pageable) {
    ...
    @Async("virtualThreadExecutor")
    @Transactional(readOnly = true)
    public CompletableFuture<PayrollBatchResponse> getBatchById(UUID batchId) {
    ...
    @Async("virtualThreadExecutor")
    @Transactional(readOnly = true)
    public CompletableFuture<Page<PayrollItemResponse>> getBatchItems(UUID batchId, Pageable pageable) {
    ...
    @Async("virtualThreadExecutor")
    @Transactional
    public CompletableFuture<PayrollItemResponse> retryPayrollItem(UUID payrollItemId) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            if (item.getPayrollItemStatus() != PayrollItemStatus.FAILED) {
                throw new PayrollProcessingException("Payroll item is not in FAILED transactionStatus: " + item.getPayrollItemStatus());
            }
    ...
    @Async("virtualThreadExecutor")
    @Transactional
    public CompletableFuture<PayrollBatchResponse> cancelBatch(UUID batchId) {
        ...
        return CompletableFuture.supplyAsync(() -> {
            ...
            if (batch.getPayrollStatus() != PayrollStatus.PENDING) {
                throw new PayrollProcessingException("Cannot cancel batch in transactionStatus: " + batch.getPayrollStatus());
            }
