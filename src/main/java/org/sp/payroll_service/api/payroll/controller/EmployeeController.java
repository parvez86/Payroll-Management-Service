...
public class EmployeeController {
    ...
    public CompletableFuture<ResponseEntity<EmployeeResponse>> createEmployee(
        ...
        return employeeService.create(request)
                .thenApply(employee -> ResponseEntity.status(HttpStatus.CREATED).body(employee));
    }
    ...
    public CompletableFuture<ResponseEntity<Page<EmployeeResponse>>> getAllEmployees(
    ...
    public CompletableFuture<ResponseEntity<EmployeeResponse>> getEmployeeById(
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYER')")
    public CompletableFuture<ResponseEntity<Page<EmployeeResponse>>> getEmployeesByGrade(
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public CompletableFuture<ResponseEntity<EmployeeResponse>> updateEmployee(
            @Parameter(description = "Employee ID") @PathVariable UUID employeeId,
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public CompletableFuture<ResponseEntity<Void>> deleteEmployee(
            @Parameter(description = "Employee ID") @PathVariable UUID employeeId) {
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYER')")
    public CompletableFuture<ResponseEntity<Object>> getEmployeeCountByGrade() {
        log.debug("Retrieving employee count by grade");
        return employeeService.getEmployeeCountByGrade()
                .thenApply(ResponseEntity::ok);
    }
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'EMPLOYER')")
    public CompletableFuture<ResponseEntity<Long>> getTotalEmployeeCount() {
